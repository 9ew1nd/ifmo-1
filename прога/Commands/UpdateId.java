...
/** Класс команды update_id, который позволяет
...
public class UpdateId implements Command{
    ...
    public UpdateId(DragonCollection collection, long id){
    ...
    public String execute(){
        if (collection.containsById(id)){
            System.out.println("Элемент с таким id присутствует, начинаем обновление");
            ...
            System.out.println("Данные записаны. Идёт обновление объекта.");
            if (!nullCaveFlag){
